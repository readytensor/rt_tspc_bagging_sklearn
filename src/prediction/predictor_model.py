...
class TimeStepClassificatier:
    """Bagging TimeStepClassificatier.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Bagging TimeStepClassificatier.
        ...
        Args:
            ...
            max_samples (int, float): Number of samples to draw from X to train each base estimator.
    ...
    def build_model(self) -> BaggingClassifier:
        """Build a new Bagging Classifier."""
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Bagging TimeStepClassificatier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassificatier":
        """Load the Bagging TimeStepClassificatier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassificatier: A new instance of the loaded Bagging TimeStepClassificatier.
        """
