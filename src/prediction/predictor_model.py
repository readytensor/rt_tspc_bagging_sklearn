...
class TSAnnotator:
    """Bagging Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TSAnnotator models.
    """
    MODEL_NAME = "Bagging_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Bagging TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Bagging TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the Bagging TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded Bagging TSAnnotator.
        """
